...
import { Card, Grid, Container, Typography, Box, CardActionArea, CardContent, AppBar, Toolbar } from '@mui/material';
      ...
      <Grid container spacing={3} sx={{ mt: 4 }}>
        {flashcards.map((flashcard) => (
          <Grid item xs={12} sm={6} md={4} key={flashcard.id}>
            <Card sx={{ backgroundColor: 'rgba(255, 255, 255, 0.5)', border: '1px solid #ccc', backdropFilter: 'blur(10px)' }}>
                      ...
                      <div>
                        <Typography 
                          ...
                          sx={{ 
                            ...
                            fontFamily: 'Montserrat, sans-serif' // Custom font style
                          }}
                        >
                          {flashcard.front}
                        </Typography>
